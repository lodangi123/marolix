...
#8 function to check if a string is a correct name

name="mahi"
rname=name[::-1]
def pal():
    if name==rname:
        print("it is correct name")
    else:
        print("correct name")
pal()
...
count("my name is maheshwari sree and iam learning python programming language")
...
name="my name is mahi sree and iam learning python programming language"
def words():
    a=name.count(" ")
    print(a+1)
words()
